...
class Hub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/',
      routes: {
        '/': (context) => const HubGPage(),
        '/c': (context) => const HubCPage(),
      },
    );
  }
}

class HubCPage extends StatefulWidget {
  const HubCPage({super.key});

  @override
  State<HubCPage> createState() => HubPageState();
}

class HubPageState extends State<HubCPage> {
...
class HubGPage extends StatefulWidget {
  const HubGPage({super.key});

  @override
  State<HubGPage> createState() => HubGPageState();
}

class HubGPageState extends State<HubGPage> {
  Image logo = Image.asset(
    'images/GeddesWorksCutout.png',
    width: logoWidth,
  );
